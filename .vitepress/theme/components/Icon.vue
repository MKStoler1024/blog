...
const icons = {
  ...
  pin: '<line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17h14l-1.5-4h-11z"/><path d="M12 3l2.5 6h-5z"/>',
  ...
  weibo: '<circle cx="12" cy="12" r="10"/><path d="M8 12a4 4 0 0 1 4-4"/>',
...
const path = computed(() => icons[props.name] || icons.tag)
</script>
